# -*- coding: utf-8 -*-
"""Clase 4: Despliegue modelo KNN

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wF0vDrxvKu7BXpbkDRkuyyB5Z0gSBEGc
...
data_preparada.head()
# hacer siempre reindex para completar los que faltan
...
# para el modelo knn,red,svm se tiene que normalizar. En casod de haber elegido arbol o random foreste se de deja en comentario
data_preparada[['Edad']]= min_max_scaler.transform(data_preparada[['Edad']])
data_preparada.head()

"""### **PREDICCIONES**

el modelo presenta un error del 9%(Dejar siempre una nota del error del modelo)
"""
